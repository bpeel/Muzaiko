...
class Calendar
{
    ...
    */
    function getMonthHTML($m, $y, $showYear = 1)
    {
    	...
    	$s .= "<tr>\n";
    	$s .= "<td align=\"center\" valign=\"top\">" . (($prevMonth == "") ? "&nbsp;" : "<a href=\"$prevMonth\"><img src=\"images/left_arrow.png\" alt=\"antaŭa monato\" /></a>")  . "</td>\n";
    	$s .= "<td align=\"center\" valign=\"top\" class=\"calendarHeader\" colspan=\"5\">$header</td>\n"; 
    	$s .= "<td align=\"center\" valign=\"top\">" . (($nextMonth == "") ? "&nbsp;" : "<a href=\"$nextMonth\"><img src=\"images/right_arrow.png\" alt=\"sekva monato\" /></a>")  . "</td>\n";
    	$s .= "</tr>\n";
